...
export const HomePageContent: NextPage = () => (
	<div className="p-6">
		<section>
			<header>
...
const AvatarExample: FC = () => (
	<Avatar bordered img="/profile-picture-5.jpg" rounded />
);

const BadgesExample: FC = () => (
